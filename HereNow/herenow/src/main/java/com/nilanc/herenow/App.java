...
/**
 * from quickblox github sample application
 */
...
public class App extends Application {
    ...
    private Map<Integer, List<Message>> allMessages = new HashMap<Integer, List<Message>>();
    ...
    public void addMessage(int userId, Message message) {
        List<Message> messages = allMessages.get(userId);
        if (messages == null) {
